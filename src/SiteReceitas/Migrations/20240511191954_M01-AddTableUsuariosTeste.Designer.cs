...
namespace SiteReceitas.Migrations
{
    ...
    [Migration("20240511191954_M01-AddTableUsuariosTeste")]
    partial class M01AddTableUsuariosTeste
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SiteReceitas.Models.Usuario", b =>
                {
                    ...
                    b.ToTable("UsuariosTeste");
                });

            modelBuilder.Entity("SiteReceitas.Models.usuarioTeste", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
